...
router.post('/interests',routeController.post_interests);
router.get('/interests/:username',routeController.get_interests);
router.put('/edit-interests',routeController.edit_interests);
