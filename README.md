...
1. **Accessing the Application**:
   - Open your web browser(Firefox) and navigate to the URL where the application is hosted ([https://gt-frontend-fawn.vercel.app/](https://gt-frontend-fawn.vercel.app/)).
