...
import InterestsPage from './components/InterestsPage.js';
import EditInterests from './components/EditInterests.js';
function App() {
        ...
        <TipProvider>
          <Router>
            <Routes>
              ...
              <Route path='/user/interests' element={<EditInterests /> } />
            </Routes>
          </Router>
          </TipProvider>
        </UserContextProvider>
