    ...
    const renderMenu = (
        ...
        >
            <MenuItem onClick={handleMenuClose}>
                ...
                >
                    <BookmarksIcon />
                    <Typography sx={{ marginLeft: '5px', fontSize: '20px' }}>Saved</Typography>
                </IconButton>
            </MenuItem>
            ...
            <Divider variant="middle" component="li" />
            <MenuItem onClick={() => showPosts()}>
                <Link to={'/user/interests'} style={{ textDecoration: "none", color: "inherit", fontSize: '20px', fontWeight: '500' }}>
                    <IconButton
                        size="small"
                        edge="end"
                        onClick={handleProfileMenuOpen}
                    ...
                    >
                        <InterestsIcon />
                        <Typography sx={{ marginLeft: '5px', fontSize: '20px' }}>Interests</Typography>
                    </IconButton>
                </Link>
            </MenuItem>
        </Menu>
